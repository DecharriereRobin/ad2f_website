                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <h5><?= $meeting['date'] ?></h5> </td>
                                    <td class="text-center">
                                        <h5><?= $meeting['address'] ?></h5> </td>
                                    <td class="text-center">
                                        <h5><?= $meeting['content'] ?></h5> </td>
                                </tr>
                            </tbody>
                        </table>
                </div>
                <div class="col-md-4 col-md-offset-2 col-xs-4 col-xs-offset-2 col-lg-4 col-lg-offset 2">
                    <form action="<?php $this->url('backoffice_MeetingEdit')?>" method="POST">
                        ...
                        <div class="text-center form-group">
                            ...
                            <textarea id="content" name="address" class="text-center form-control">
                                <?= $meeting['address'] ?>
                            </textarea>
                        </div>
                        <div class="text-center form-group">
                            <label for="content">Modifier la description</label>
                            <textarea id="content" name="content" class="text-center form-control">
                                <?= $meeting['content'] ?>
                            </textarea>
                        </div>
