...
<main>
  <div class="container">
    ...
    <div class="col-xs-12">
      <form class="well form-horizontal" action="<?php $this->url('association_contact') ?> " method="post"  id="contact_form">
      <fieldset>
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <textarea name="message" placeholder="Taper votre message ici..." class="form-control"  type="text"></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="col-md-4">
          <button type="submit" class="btn btn-default btn_form_submit" name="SendMail" >Envoyer <span class="glyphicon glyphicon-send"></span></button>
        </div>
      </div>
